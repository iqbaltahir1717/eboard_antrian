...
class Setting extends CI_Controller
{
	...
	public function update()
	{
		...
		$data['setting_max_antrian']           = $this->input->post('setting_max_antrian');
		$data['setting_jam_buka']           = $this->input->post('setting_jam_buka');
		$data['setting_jam_tutup']           = $this->input->post('setting_jam_tutup');
