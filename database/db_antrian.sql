...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Jan 2023 pada 16.01
...
INSERT INTO `tbl_antrian` (`antrian_kode`, `antrian_nomor`, `user_id`, `spesialis_id`, `arrival_time`, `service_start_time`, `service_end_time`) VALUES
('FN-2023010217223221', 'A-2', 21, 1, '17:22:32', '00:00:00', '00:00:00');
...
--
ALTER TABLE `tbl_riwayat_antrian`
  MODIFY `riwayat_antrian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
